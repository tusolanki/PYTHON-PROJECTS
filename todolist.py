...
def Task_completed():  
    ...
    try:  
        ...
        if the_value in tasks:
         tasks.remove(the_value)
         messagebox.showinfo( 'Approved',' Task Selected has been completed.') 
         list_update()
         the_cursor.execute('delete from tasks where title = ?', (the_value,))  
...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Manager - TUSHAR DILIPKUMAR")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#BC8F8F")  
    functions_frame = tk.Frame(guiWindow, bg = "#BC8F8F")  
    listbox_frame = tk.Frame(guiWindow, bg = "#BC8F8F")  
